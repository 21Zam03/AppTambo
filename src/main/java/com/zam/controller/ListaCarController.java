...
@WebServlet(name = "ListaCarController", urlPatterns = {"/ListaCar"})
public class ListaCarController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Carrito> lista = carritoDao.listarCarritos(cliente);
        
        ObjectMapper mapper = new ObjectMapper();
        String jsonCarritos = mapper.writeValueAsString(lista);
        
        try (PrintWriter out = response.getWriter()) {
            out.println(jsonCarritos);
        }
    }
